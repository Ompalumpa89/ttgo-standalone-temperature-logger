...
Do not remove the SD card while the logger is powered and writing data. Power off the unit before removing the SD card to avoid corrupting the file system.
